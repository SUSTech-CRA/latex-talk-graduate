...
\begin{frame}{你也可以帮助}
  \begin{itemize}
    \item 错误反馈、改进建议：GitHub Issues \link{https://github.com/SUSTech-CRA/latex-talk-graduate/issues}
...
\begin{frame}{感谢}
  \begin{itemize}
    \item 南方科技大学研究生院
    \begin{itemize}
      \item 研究生学位论文LaTeX写作模板 \link{https://gs.sustech.edu.cn/xueweishouyuzhengce/2000}
      \item 讲解视频 \link{https://www.bilibili.com/video/BV1JU4y1g7bH}
    \end{itemize}
    \item SUSTech-CRA 提供资源支持：ShareLaTeX，CTAN mirror
    \item 基于《LaTeX 入门》 南方科技大学图书馆培训讲座 \link{https://github.com/SUSTech-CRA/latex-talk} 的幻灯片修改
