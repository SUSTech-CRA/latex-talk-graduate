...
\begin{frame}{你也可以帮助}
  \begin{itemize}
    \item 错误反馈、改进建议：GitHub Issues \link{https://github.com/SUSTech-CRA/latex-talk-master/issues}
...
\begin{frame}{感谢}
  \begin{itemize}
    ...
    \item 本幻灯片下载地址 \url{https://github.com/SUSTech-CRA/latex-talk-master}
  \end{itemize}
\end{frame}
