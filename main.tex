...
\author[CRA 计算机研究协会]{李子强 \inst{1} \and 李可明 \inst{2}}
...

{
    ...
    \begin{frame}{}
        ...
        \begin{columns}
            \column{.48\textwidth}
            \begin{figure}
                \includegraphics[width=0.6\textwidth]{latex_qq_group.png}
            \end{figure}

            \column{.48\textwidth}
            \begin{figure}
                \includegraphics[width=0.6\textwidth]{master-report-qq.jpeg}
            \end{figure}
        \end{columns}
